...
class CBFKNNRecSys():
    ...
    def __init__(self, URM_train, ICM, k=100, shrink=0):
    ...
    def fit(self):
        self._similarity_matrix = Cosine_Similarity(self._ICM.T, self._k, self._shrink).compute_similarity()
...
if __name__ == '__main__':
    ...
    recommended = cbf.recommendALL(target.values)
