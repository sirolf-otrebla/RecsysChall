...
cdef class Cosine_Similarity:
    ...
    cdef int TopK
    cdef long long n_items, n_users
    ...
    cdef double[:] computeItemSimilarities(self, long long item_id_input):
        """
        ...
        cdef long long user_index, user_id, item_index, item_id_second
