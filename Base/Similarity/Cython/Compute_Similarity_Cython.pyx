...
cdef class Compute_Similarity_Cython:
    ...
    cdef int TopK
    cdef long long n_columns, n_rows
    ...
    cdef applyPearsonCorrelation(self, dataMatrix):
        ...
        cdef long long colIndex, innerIndex, start_pos, end_pos
    ...
    cdef applyAdjustedCosine(self, dataMatrix):
        ...
        cdef long long rowIndex, innerIndex, start_pos, end_pos
    ...
    #     return pointer
    #
    # cdef data_pointer_s getItemsRatedByUser_pointer(self, long long user_id):
    #
    #
    #     cdef data_pointer_s pointer = data_pointer_s()
    #
    ...
    cdef computeItemSimilarities(self, long long item_id_input):
        """
        ...
        That is VERY slow due to the common user part, in which a long long data structure is looped multiple times.
        ...
        cdef long long user_index, user_id, item_index, item_id, item_id_second
    ...
    def compute_similarity(self, start_col=None, end_col=None):
        ...
        cdef long long processedItems = 0
        ...
        cdef long long sparse_data_pointer = 0
...
cdef long long[:] argsort(double[:] this_item_weights, int TopK):

    #start_time = time.time()
    cdef array[long long] template_zero = array('l')
    cdef array[long long] result = clone(template_zero, TopK, zero=False)
