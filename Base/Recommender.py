...
class Recommender(object):
    ...
    def evaluateRecommendations(self, URM_train_new, URM_test_new, at=5, minRatingsPerUser=1, exclude_seen=True,
        ...
        self.URM_train = check_matrix(URM_train_new, format='csr')
        self.at = at
